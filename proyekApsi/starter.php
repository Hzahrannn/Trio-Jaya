            ...
            <div class="card">
                ...
                <div class="card-tools">
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                      <a href="#" class="dropdown-item">Urutkan Perbulan</a>
                      <a href="#" class="dropdown-item">Urutkan Per 6 bulan</a>
                      <a href="#" class="dropdown-item">Urutkan Per Tahun</a>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-8">
                    <p class="text-center">
                      <strong>Penjualan: 1 Jan, 2020 - 30 Jun, 2020</strong>
                    </p>
                ...
                <div class="row">
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      <h5 class="description-header">Rp 4,583,500</h5>
